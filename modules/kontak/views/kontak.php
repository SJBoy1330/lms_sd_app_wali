                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col align-self-center ps-4 text-detail-kbm">
                                    ...
                                    <p class="fw-normal text-secondary size-14">0812334321234</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-6 mx-auto">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col align-self-center ps-4 text-detail-kbm">
                                    <p class="mb-0 size-15 fw-medium">Wali Kelas</p>
                                    <p class="fw-normal text-secondary size-14">0812334321234</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col align-self-center ps-4 text-detail-kbm">
                                    ...
                                    <p class="fw-normal text-secondary size-14">Drs. Hendrawati Kusumaningsih...</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-6 mx-auto">
                    <div class="card mb-3">
                        <div class="col-auto position-absolute avatar-detail-kbm">
                            <div class="avatar avatar-60 shadow-sm rounded-18 avatar-presensi-outline">
                               <div class="avatar avatar-50 rounded-18 avatar-presensi-inline">
                                    <i class="fa-solid fa-envelope size-26 text-white"></i>
                               </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col align-self-center ps-4 text-detail-kbm">
                                    <p class="mb-0 size-15 fw-medium">Email</p>
                                    <p class="fw-normal text-secondary size-14">smanasional@gmail.com</p>
                                </div>
                            </div>
                        </div>
                    </div>
