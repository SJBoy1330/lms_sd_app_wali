        ...
        <form class="row">
            <div class="form-group mb-4">
                ...
                <div class="wrapper-password d-flex">
                    <input type="password" class="form-control form-control-pribadi text-start" name="kata_sandi" id="nowpassword" placeholder="Masukkan kata sandi sekarang" autocomplete="off">
            ...
            <div class="form-group mb-4">
                ...
                <div class="wrapper-password d-flex">
                    <input type="password" class="form-control form-control-pribadi text-start" name="kata_sandi" id="newpassword" placeholder="Masukkan kata sandi baru" autocomplete="off">
            ...
            <div class="form-group mb-4">
                ...
                <div class="wrapper-password d-flex">
                    <input type="password" class="form-control form-control-pribadi text-start" name="kata_sandi" id="repeat-newpassword" placeholder="Masukkan kata sandi baru" autocomplete="off">
