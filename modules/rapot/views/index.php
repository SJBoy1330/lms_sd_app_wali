            ...
            <div class="modal-body">
                <div class="row mb-3">
                    <div class="col-6 pe-1">
                        <div class="card">
                            <div class="card-body detail-ujian">
                                <div class="row">
                                    ...
                                    <div class="col align-self-center ps-0 pe-0">
                                        ...
                                        <p class="mb-0 size-12 fw-normal text-secondary">Bahasa Indonesia Bahasa Indonesia</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body detail-ujian">
                                <div class="row">
                                    ...
                                    <div class="col align-self-center ps-0 pe-0">
                                        <p class="mb-0 size-14 fw-medium">Batas Akhir</p>
                                        <p class="mb-0 size-12 fw-normal text-secondary">30 Maret 2022</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body detail-ujian">
                                <div class="row">
                                    ...
                                    <div class="col align-self-center ps-0 pe-0">
                                        ...
                                        <p class="mb-0 size-12 fw-normal text-secondary">Tugas Bahasa Indonesia</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body detail-ujian">
                                <div class="row">
                                    ...
                                    <div class="col align-self-center ps-0 pe-0">
                                        <p class="mb-0 size-14 fw-medium">Status Ujian</p>
                                        <p class="mb-0 size-12 fw-normal text-success">Tuntas</p>
                                    </div>
                                </div>
                            </div>
                        </div>
